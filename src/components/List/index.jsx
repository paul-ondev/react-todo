  ...
  return (
    <ul onClick={onClick} className='list' >
      {items.map((item, index) => (
        <li onClick={ItemClick ? () => ItemClick(item) : null} className={classNames(item.className, { active: item.active ? item.active : activeItem && activeItem.id === item.id })} key={index}>
